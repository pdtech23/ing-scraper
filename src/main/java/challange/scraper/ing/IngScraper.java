package challange.scraper.ing;

import challange.model.Account;
import challange.scraper.Scraper;
import challange.scraper.ing.accounts.AccountsFetchingStrategy;
import challange.scraper.ing.session.authenticated.AuthenticatedSessionFetchingStrategy;
import challange.scraper.ing.session.unauthenticated.UnauthenticatedSessionFetchingStrategy;
